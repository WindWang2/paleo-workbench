...
def ensure_dirs():
    """Create output dirs. Called from __main__ only (ISSUE-022): importing
    this module must not touch the filesystem or print skip lines."""
...
T = "岩石纹理"
def build_entries():
    """Populate the catalog (called from __main__ only)."""
