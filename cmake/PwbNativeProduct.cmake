...
set(PWB_NATIVE_PRODUCT_CAPABILITIES
    ...
    "qgis_layout|QGIS 原生版式权威（QgsLayoutManager 持久布局）|PWB_BUILD_CONV_29|hard"
...
set(PWB_NATIVE_PRODUCT_LINK_CLOSURE
    ...
    "qgis_layout|Pwb::MappingDocument|Pwb::Qgis|-"
...
function(pwb_native_product_summary)
    ...
    foreach(_cap IN LISTS PWB_NATIVE_PRODUCT_CAPABILITIES)
        ...
        elseif(TARGET ${_probe})
            if(_class STREQUAL "kernel")
                set(_state "kernel-only")
            else()
                set(_state "linked")
            endif()
        else()
