...
// Minimal deterministic test harness for closure_review tests (line 09).
// Same shape as libs/ui_review/ui_review_tests/ui_review_test.hpp —
// self-registering PWB_TEST, counted (not aborting) failures.
