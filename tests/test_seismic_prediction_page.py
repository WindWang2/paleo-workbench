...
def test_seismic_prediction_page_update_delegates(qtbot):
    ...
    page.view_panel.update_state = lambda task: calls["view"].append(task)
    page.control_panel.update_state = lambda task, volume_shape=None: calls["control"].append((task, volume_shape))
