"""Well-section canvas / host / panel integration tests.

Ported from well-log-engine `apps/wellplot-desktop/tests/` (workbench #734):
the engine-repo copies imported paleo_workbench and geoviz, which are not
available there, so the coverage lives in the monorepo suite.
"""
